...
# -----------------------------------------------------------------------------
#' Example data frame containing numbers of antibiotic prescriptions in long
#' format
#'
...
#' * Spectrum - The spectrum of activity of the antibiotic.
#'   This value is always the same for a particular antibiotic
